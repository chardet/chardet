...
**99.7% accuracy** on 3,121 test files. **279x faster** than chardet 6.0.0,
...
| Speed                  | **2,675 files/s** (645 pure) |  10 files/s   |        2,100 files/s        |
...
- **279x faster** than chardet 6.0.0 when compiled, and 1.3x faster than charset-normalizer 3.5.0 overall (2.1x at the median) while being far more accurate
...
- **Optional compiled builds:** mypyc plus a Cython scoring kernel, 4.9x additional speedup on CPython
