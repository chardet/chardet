...
class CharDistributionAnalysis:
    ...
    _table_size: int  # Size of above table
    _done: bool
    _total_chars: int
    _freq_chars: int
    # This is a constant value which varies from language to language, used in
    # calculating confidence. See
    # http://www.mozilla.org/projects/intl/UniversalCharsetDetection.html for
    # further detail.
    typical_distribution_ratio: float
    ...
    def get_order(self, byte_str: Sequence[int]) -> int:
